...
<sld:UserStyle xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml">
  ...
  <sld:Title> Neighbourhood Character Overlay</sld:Title>
  <sld:Abstract>Zones styled by hexadecimal value stored in the database (view).</sld:Abstract>
  <sld:FeatureTypeStyle>
    <sld:Name>name</sld:Name>
    
    <sld:Rule>
    <sld:Name>Neighbourhood Character Overlay</sld:Name>
      <ogc:Filter>
        <ogc:PropertyIsEqualTo>
          <ogc:PropertyName>group1</ogc:PropertyName>
          <ogc:Literal>NEIGHBOURHOOD CHARACTER OVERLAY</ogc:Literal>
        </ogc:PropertyIsEqualTo>
      </ogc:Filter>
