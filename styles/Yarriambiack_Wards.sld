  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
          <sld:Title>HOPETOUN</sld:Title>
          <ogc:Filter>
           <ogc:And>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>lga_name</ogc:PropertyName>
              <ogc:Literal>YARRIAMBIACK</ogc:Literal>
            </ogc:PropertyIsEqualTo>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ward_name</ogc:PropertyName>
              <ogc:Literal>HOPETOUN</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:And>
          </ogc:Filter>
        ...
        <Rule>
          ...
          <ogc:Filter>
            ...
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ward_name</ogc:PropertyName>
              <ogc:Literal>WARRACKNABEAL</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:And>
          </ogc:Filter>
          <PolygonSymbolizer>
        ...
        <Rule>
          ...
          <ogc:Filter>
            ...
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ward_name</ogc:PropertyName>
              <ogc:Literal>DUNMUNKLE</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:And>
          </ogc:Filter>
          <PolygonSymbolizer>
